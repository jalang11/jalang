...
print '''		
            ...
            Fast SMtp Cracker    							    	5000+ smtp per day									

            Inbuild Threads No Setup    							5000+ smtp per day		

            Script Cracks Webmail Account							5000+ smtp per day

            Tool Work										Intelligent Cracker


''' 
ms0g = 'FOR MORE FREE TOOLS VISIT  --FREESPAMTOOLS.COM-- '		
for i in ms0g:		
    sys.stdout.write(i)		
    sys.stdout.flush()		
    time.sleep(0.05)
